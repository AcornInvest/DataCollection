...
get_OHLCV_Intelliquant = GetOHLCV_Intelliquant(logger)
...
get_OHLCV_Intelliquant.run_backtest_rep(datemanage)
#get_OHLCV_Intelliquant.process_OHLCV_original(datemanage, 'Listed')

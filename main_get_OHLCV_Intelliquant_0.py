...
#get_OHLCV_Intelliquant.run_backtest_rep(datemanage, 12, 12) # workday = date(2007, 12, 31)

for num in [87,26,1,52,59]:
    get_OHLCV_Intelliquant.run_backtest_rep(datemanage, num, num)  # workday = date(2007, 12, 31)

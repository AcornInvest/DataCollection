...
startday = datetime(2023, 12, 1) # 직전 financial 결과가 나오는 날부터로 함
...
#GetFinancData.run_backtest_rep(datemanage,  all_files=False, first_index=50, final_index=167) # 인텔리퀀트로 백테스트 돌려서 크롤링
